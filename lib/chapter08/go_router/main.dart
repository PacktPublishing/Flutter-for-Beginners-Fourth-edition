...
class _MyAppState extends State<MyApp> {
  ...
  final _router = GoRouter(
    routes: [
      GoRoute(
        path: '/',
        builder: (context, state) => FootballGroundListWidget(),
      ),
      GoRoute(
        path: '/footballground/:footballGroundName',
        builder: (context, state) => FootballGroundDetailsWidget(footballGroundName: state.pathParameters['footballGroundName']!),
      ),
    ],
  );
}
